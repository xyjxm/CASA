...
from gear_sonic.casa.phase5_hybrid import HYBRID_METHOD_DISPLAY, HYBRID_METHOD_ORDER
...
ONLINE_METHOD_ORDER = (*METHOD_ORDER, *ONLINE_CANDIDATE_METHODS, *SOTA_METHOD_ORDER, *HYBRID_METHOD_ORDER)
