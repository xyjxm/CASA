...
# Usage:
#   WIFI_SSID="MyWifi" WIFI_PASSWORD="<wifi-password>" WIFI_GATEWAY="192.168.x.x" ./setup_wifi.sh
#   ./setup_wifi.sh --ssid "MyWifi" --password "<wifi-password>" --interface "wlan0" --gateway "192.168.x.x"
WIFI_SSID="${WIFI_SSID:-}"
